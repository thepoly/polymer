...
import SportsPageLayout from './collections/SportsPageLayout.ts'
...
export default buildConfig({
  ...
  collections: [Users, Media, Articles, JobTitles, Layout, OpinionPageLayout, FeaturesPageLayout, SportsPageLayout, Submissions, EventSubmissions],
