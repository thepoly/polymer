...
const Articles: CollectionConfig = {
  ...
  fields: [
    ...
    { name: 'title', type: 'text', required: true },
    {
      ...
      label: 'Team',
      options: [
        { label: "Men's Basketball", value: 'mens-basketball' },
        { label: "Women's Basketball", value: 'womens-basketball' },
        { label: "Men's Hockey", value: 'mens-hockey' },
        { label: "Women's Hockey", value: 'womens-hockey' },
        { label: 'Football', value: 'football' },
        { label: "Men's Soccer", value: 'mens-soccer' },
        { label: "Women's Soccer", value: 'womens-soccer' },
        { label: "Men's Lacrosse", value: 'mens-lacrosse' },
        { label: "Women's Lacrosse", value: 'womens-lacrosse' },
        ...
        { label: 'Club Sports', value: 'club-sports' },
        { label: 'Intramurals', value: 'intramurals' },
        { label: 'Other', value: 'other' },
      ],
      admin: {
        condition: (data) => data.section === 'sports',
      },
    },
    {
      name: 'kicker',
