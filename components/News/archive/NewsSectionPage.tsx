/**
 * ARCHIVED — kicker-driven /news section page (in production through Sept 2026).
 *
 * Replaced by `components/News/NewsSectionPage.tsx`, which mirrors the Features
 * page layout. This file is kept for reference/restore only; nothing imports it.
 * See `components/News/archive/README.md` for why it was retired and how to
 * bring it back.
 */
