      ...
      <div className="relative w-full h-screen mb-10 bg-black text-white overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 z-10 flex flex-col items-center text-center px-4 pb-3 sm:pb-5 md:pb-6 pointer-events-none">
          <div className="max-w-3xl w-full space-y-1">
            ...
            <h1 className={`font-display font-bold text-[28px] md:text-[34px] lg:text-[42px] text-white leading-[1.05] tracking-[-0.02em] drop-shadow-lg ${article.section === "news" ? "font-display-news uppercase" : ""} ${article.section === "features" ? "font-normal italic" : ""} ${article.section === "sports" ? "italic tracking-[0.015em]" : ""}`}>
              {article.title}
            </h1>
