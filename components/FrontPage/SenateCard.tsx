...
export const SenateCard = ({ article }: { article: Article }) => (
    <div className="flex flex-col md:flex-row gap-6 cursor-pointer group mt-5 border-t border-gray-300 pt-5">
        <div className="flex-1 flex flex-col justify-center">
             <div className="mb-2">
                <span className="text-[#D6001C] font-bold font-serif uppercase text-xs tracking-wider">Student Senate</span>
            </div>
            <h3 className="font-serif font-bold text-xl md:text-2xl text-gray-900 mb-3 leading-tight">
                {article.title}
            </h3>
