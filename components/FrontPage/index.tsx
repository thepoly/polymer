...
export function SectionBlock({
  ...
  return (
    <section data-section={sectionSlug}>
      <div className="mb-3">
        <div className="relative -left-2 w-[calc(100%+0.5rem)] border-t border-black dark:border-white md:border-rule transition-colors" />
      ...
      <div className="flex flex-col md:hidden">
        {allSectionArticles.map((article, i) => (
          <div key={article.id} className={i > 0 ? "mt-[5.33px] pt-[5.33px] border-t border-black dark:border-white" : ""}>
            <ArticleCard
              article={article}
        ...
        <div className="pt-2 flex flex-col md:hidden" data-frontpage-top>
          ...
          {(() => {
            ...
            return ordered.map((article, i) => (
              <div key={`${article.id}-${i}`} className="mt-[4.44px] pt-[4.44px] border-t border-black dark:border-white md:mt-10 md:pt-10 md:border-rule transition-colors">
